          ...
          <div className="min-h-screen flex flex-col justify-center space-y-12">
            ...
            <div className="framer-hero-title">
              <h1 className="text-7xl md:text-9xl font-black tracking-tight leading-none">
                ...
                <div className="framer-text-reveal">
                  <span className="block text-white/80 framer-stagger-2">
                    Hassan
                  </span>
                </div>
              </h1>
            ...
            <div className="framer-hero-cta">
              <div className="flex flex-col sm:flex-row items-start gap-6">
                <button
                  onClick={() => {
                    window.location.href =
                      "https://drive.google.com/file/d/1Mb2jyHZpzSVzKV8zbENy9B3n16UImHX3/view?usp=sharing";
                  }}
                  className="group bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-4 rounded-2xl font-semibold text-lg flex items-center gap-3 framer-button framer-magnetic shadow-2xl"
                >
                ...
                <div className="flex gap-4">
                  <button
                    onClick={() => {
                      window.location.href = "https://github.com/codeblooded47";
                    }}
                    className="p-4 bg-white/10 hover:bg-white/20 backdrop-blur-md rounded-2xl border border-white/20 transition-all duration-300 hover:scale-110 framer-magnetic"
                  >
                  ...
                  <button
                    onClick={() => {
                      window.location.href =
                        "https://linkedin.com/in/codeblooded47";
                    }}
                    className="p-4 bg-gradient-to-br from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 rounded-2xl transition-all duration-300 hover:scale-110 framer-magnetic shadow-lg"
                  >
